package javatechonline.crudmvcrestexample.controller;
...
import javatechonline.crudmvcrestexample.service.InvoiceService;
...
public class InvoiceController {
    ...
    public String saveInvoice(@ModelAttribute Invoice invoice,Model model){
        ...
        String message = "Record with id : "+id+" is saved successful";
    ...
    public String updateInvoice(
        ...
        attributes.addAttribute("message", "Invoice "+id+" updated");
    ...
    public String deleteInvoice(
        ...
        try{
            ...
            attributes.addAttribute("message", "Invoice with id "+id+" is removed");
        }catch (InvoiceNotFoundException e){
            e.printStackTrace();
            attributes.addAttribute("message", e.getMessage());
        }
