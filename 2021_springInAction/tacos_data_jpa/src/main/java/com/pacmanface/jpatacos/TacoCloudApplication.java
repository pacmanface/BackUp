package com.pacmanface.jpatacos;
...
public class TacoCloudApplication {
	...
	@Bean
	public CommandLineRunner init(IngredientRepository repository) {
		return args -> {
			...
			repository.save(new Ingredient("JACK", "Monterey Jack", Ingredient.Type.CHEESE));
